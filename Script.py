...
ɪᴛs ᴇᴀsʏ ᴛᴏ ᴜsᴇ ᴍᴇ ɪᴜsᴛ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀs ᴀᴅᴍɪɴ ᴛʜᴀᴛs ᴀʟʟ ɪ ᴡɪʟʟ ᴘʀᴏᴠɪᴅᴇ ᴍᴏᴠɪᴇs ᴛʜᴇʀᴇ.</b>"""
...
<code>[Button Text](buttonalert:ᴛʜɪꜱ ɪꜱ ᴀɴ ᴀʟᴇʀᴛ ᴍᴇꜱꜱᴀɢᴇ)</code>"""
    ...
    AUTOFILTER_TXT = """<b>ʜᴇʟᴘ: ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ</b>
...
• /connections - <code>ʟɪꜱᴛ ᴀʟʟ ʏᴏᴜʀ ᴄᴏɴɴᴇᴄᴛɪᴏɴꜱ</code>"""
    ...
    EXTRAMOD_TXT = """<b>ʜᴇʟᴘ : ᴇxᴛʀᴀ ᴍᴏᴅᴜʟᴇs
...
• /delallg - <code>ᴛᴏ ᴅᴇʟᴇᴛᴇ ᴀʟʟ ɢʟᴏʙᴀʟ ꜰɪʟᴛᴇʀꜱ.</code>"""
    ...
    FILE_STORE_TXT = """
<b>ғɪʟᴇ sᴛᴏʀᴇ ɪs ᴛʜᴇ ғᴇᴀᴛᴜʀᴇ ᴡʜɪᴄʜ ᴡɪʟʟ ᴄʀᴇᴀᴛᴇ ᴀ sʜᴀʀᴇᴀʙʟᴇ ʟɪɴᴋ ᴏғ ᴀ sɪɴɢʟᴇ ᴏʀ ᴍᴜʟᴛɪᴘʟᴇ ғɪʟᴇs.
...
• Lᴏɢᴏ Mᴀᴋᴇʀ : <a href='t.me/PremiumlogoPro'>Pʀᴇᴍɪᴜᴍ Lᴏɢᴏ Pʀᴏ</a></b>"""
    ...
    MISC_TXT = """
<b>ᴀɴ ᴏᴅᴅs ᴀɴᴅ ᴇɴᴅs ᴍᴏᴅᴜʟᴇ ғᴏʀ sᴍᴀʟʟ, sɪᴍᴘʟᴇ ᴄᴏᴍᴍᴀɴᴅs ᴡʜɪᴄʜ ᴅᴏɴ'ᴛ ʀᴇᴀʟʟʏ ғɪᴛ ᴀɴʏᴡʜᴇʀᴇ.</b>"""
